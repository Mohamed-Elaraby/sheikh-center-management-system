                                        ...
                                        <div class="to_section">
                                            ...
                                            <div class="padding-0 col-xs-4">
                                                <div class="client_data">
                                                    ...
                                                    <div class="padding-0 col-xs-12">
                                                        <span class="arabic text-center">
                                                            {{ $check -> client? $check -> client -> phone: '' }}
                                                        </span> <!-- end span -->
                                                    </div> <!-- end col 12 -->
                    ...
                    <div class="footer-info" style=" margin-top: 10px; ">
                        <table class="table table-borderless" style="font-size: x-small;">
                            ...
                            <tbody>
                                <tr>
                                    <th>الموقع</th>
                                    <td>مخرج 18 صناعية</td>
                                    <td>الصحافة حي الياسمين مخرج 5</td>
                                    <td>حي السلي شارع الصفا</td>
                                    <td>الصناعية القديمة خلف شلنجر</td>
                                    <td>بجوار الفرع الرئيسي</td>
                                    <td>شمال الرياض حي النرجس</td>
                                </tr>
                                <tr>
                                    <th>الهاتف</th>
                                    <td>0554773357</td>
