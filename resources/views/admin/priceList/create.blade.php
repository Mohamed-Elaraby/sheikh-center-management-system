            ...
            <div>
                <div class="card card-success">
                    <div class="error_messages">
                        ...
                        <div class="card-body">
                            {!! Form::open(['route' => 'admin.priceList.store', 'method' => 'post', 'id' => 'priceList']) !!}
                            <div class="col-xs-12 col-custom-style">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-3">
                                        ...
                                        {!! Form::text('price_list_number', null, ['class' => 'form-control']) !!}
                                    </div>
...
{{--                                                <td><input id="item_code_' + count + '" name="product_data[0][item_code]" type="text" class="form-control item_code" value="'+productCode+'" readonly></td>--}}
                                                <td><input id="item_name_0" name="product_data[0][item_name]" type="text" class="form-control item_name"></td>
                                                <td><input id="item_quantity_0" name="product_data[0][item_quantity]" type="text" class="form-control item_quantity onlyUsedForValidation" autocomplete="off"></td>
                                                <td><input id="item_price_0" name="product_data[0][item_price]" type="text" class="form-control item_price momo onlyUsedForValidation" autocomplete="off"></td>
                                                <td><input id="item_amount_taxable_0" name="product_data[0][item_amount_taxable]" type="text" class="form-control item_amount_taxable" readonly></td>
                                                <td>
                                                    <div class="input-group my-group">
                                                        <select id="discount_type_0" class="form-control discount_type" name="product_data[0][item_discount_type]">
                                                            <option value="0">ريال</option>
                                                            <option value="1">%</option>
                                                        </select>
                                                        <input id="item_discount_0" name="product_data[0][item_discount]" type="text" class="form-control item_discount" autocomplete="off">
                                                    </div>
                                                </td>
                                                <input type="hidden" name="product_data[0][item_discount_amount]" class="item_discount_amount">
                                                <input type="hidden" name="product_data[0][item_sub_total_after_discount]" class="item_sub_total_after_discount">
                                                <td><input id="item_tax_amount_0" name="product_data[0][item_tax_amount]" type="text" class="form-control item_tax_amount" readonly></td>
                                                <td><input id="item_sub_total_0" name="product_data[0][item_sub_total]" type="text" class="form-control item_sub_total" readonly></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
...
@push('scripts')
    ...
    <script>
        ...
        // check if sale price less than purchasing price
        // $(document).on('keyup', '.item_price', function () {
        //     let selectedRow = $(this).closest('tr');
        //     let itemPrice = $(this).val();
        //     let itemCode = selectedRow.find('.item_code').val();
        //     let itemRowInProductCodesArea = $('#product_row_id_'+ itemCode).closest('tr');
        //     let itemPurchasePrice = itemRowInProductCodesArea.find('.product_price').text();
        //     if (parseInt(itemPrice) < parseInt(itemPurchasePrice))
        //     {
        //         selectedRow.find('.item_price_error').css({'display': 'inline', 'font-size': 'x-small', 'font-style': 'italic', 'margin-bottom': '5px', 'font-weight': '700'}).text('سعر البيع اقل من سعر التكلفة');
        //     }else {
        //         selectedRow.find('.item_price_error').css('display', 'none').text();
        //     }
        // })
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#addNewRow',function (e) {
                ...
                html = '<tr>\n' +
                    ...
                    '<td><input id="item_price_' + count + '" name="product_data[' + count + '][item_price]" type="text" class="form-control item_price momo onlyUsedForValidation" autocomplete="off"></td>\n' +
