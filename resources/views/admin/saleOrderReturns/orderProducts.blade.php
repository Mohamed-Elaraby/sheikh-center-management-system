    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="card-header">
                <h3 class="text-center"><i class="fa fa-cart-arrow-down"></i> {{ $pageType .' '. $pageItem . ' [ '. $saleOrderReturns -> invoice_number .' ] '}}</h3>
            </div>
            <div class="card-body">
                <table class="table table-responsive table-striped table-bordered">
                    ...
                    <tbody>
                    @foreach ($saleOrderReturns -> saleOrderReturnProducts as $key => $product)
                        <tr>
                            <td>{{ $key+1  }}</td>
