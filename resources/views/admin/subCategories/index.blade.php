...
@section('title', __('trans.all sub categories list'))
        ...
        <div class="col-xs-12">
            <div class="card">
                ...
                <div class="card-header" style="margin: 20px 0">
                    <div class="row">
                        <div class="col-xs-9">
                            <h4 style="margin: 0; padding: 0; display: inline">{{ __('trans.all sub categories list') }}</h4>
                        </div>
                        <div class="col-xs-3">
                            @if (Auth::user()->hasPermission('create-subCategories'))
                                <a href="{{ route('admin.subCategories.create') }}" class="btn btn-success btn-sm pull-right"><i
...
@push('scripts')
    ...
    <script>
        ...
        $('#filter_date_button').on('click', function () {
            ...
            let table = $('#subcategoriesdatatable-table');
