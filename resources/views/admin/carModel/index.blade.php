...
@section('title', __('trans.all car model'))
        ...
        <div class="col-xs-12">
            <div class="card">
                ...
                <div class="card-header" style="margin: 20px 0">
                    <div class="row">
                        <div class="col-xs-6">
                            <h3 style="margin: 0; padding: 0; display: inline"> <i class="fa fa-car"></i> {{ __('trans.all car model')}}</h3>
                        </div>
                        <div class="col-xs-6">
                            @if (Auth::user()->hasPermission('create-carModel'))
                                <a href="{{ route('admin.carModel.create') }}" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> {{ __('trans.create') }}</a>
                            @endif
                        </div>
                    </div>
                </div>
...
{{--                    <table id="carModel_table" class="table table-bordered table-striped">--}}
{{--                        <thead>--}}
{{--                        <tr>--}}
{{--                            <th>#</th>--}}
...
{{--                                        <a href="{{ route('admin.carModel.edit', $car->id) }}" class="btn btn-sm btn-primary"> <i class="fa fa-edit"></i> {{ __('trans.edit') }}</a>--}}
{{--                                    @endif--}}
{{--                                    @if (Auth::user()->hasPermission('delete-carModel'))--}}
{{--                                        {!! Form::open(['route' => ['admin.carModel.destroy', $car->id], 'method' => 'delete', 'style' => 'display:inline']) !!}--}}
