...
@section('title',  $client -> name . ' | الرصيد النهائى '. number_format($client -> balance, 2))
        ...
        <div class="col-xs-12">
            <div class="card">
                ...
                <div class="card-header" style="margin: 20px 0">
                    <div class="row">
                        <div class="col-xs-12">
                            <h3 class="text-center"><i class="fa fa-exchange"></i> {{ $pageItem . ' [ '. $client -> name.' ] '}}</h3>
                            <h4 class="text-center">
                                <i class="fa fa-money"></i> {{ __('trans.balance') .' [ '.number_format($client -> balance, 2).' ] '}}
...
@push('scripts')
    ...
    <script>
        ...
        $('#filter_date_button').on('click', function () {
            ...
            let table = $('#clienttransactiondatatable-table');
