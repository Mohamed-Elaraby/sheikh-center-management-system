...
@section('title', __('trans.all car type'))
        ...
        <div class="col-xs-12">
            <div class="card">
                ...
                <div class="card-header" style="margin: 20px 0">
                    <div class="row">
                        <div class="col-xs-6">
                            <h3 style="margin: 0; padding: 0; display: inline"> <i class="fa fa-car"></i> {{ __('trans.all car type') }}</h3>
                        </div>
                        <div class="col-xs-6">
                            @if (Auth::user()->hasPermission('create-carType'))
                                <a href="{{ route('admin.carType.create') }}" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> {{ __('trans.create') }}</a>
                            @endif
                        </div>
                    </div>
                </div>
