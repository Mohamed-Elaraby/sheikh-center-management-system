...
@section('title', __('trans.all client collecting list'))
        ...
        <div class="col-xs-12">
            <div class="card">
                ...
                <div class="card-header" style="margin: 20px 0">
                    <div class="row">
                        <div class="col-xs-12">
                            <h4 style="margin: 0; padding: 0; display: inline">{{__('trans.all client collecting list')}}</h4>
                        </div>
{{--                        <div class="col-xs-3">--}}
{{--                            @if (Auth::user()->hasPermission('create-clientCollecting'))--}}
{{--                                <a href="{{ route('admin.clientCollecting.create') }}" class="btn btn-success btn-sm pull-right"><i--}}
...
@push('scripts')
    ...
    <script>
        ...
        $('#filter_date_button').on('click', function () {
            ...
            let table = $('#clientcollectingdatatable-table');
