...
<div class="buttons_area">
    ...
    <a href="{{ route('admin.clientCollecting.index') }}" class="btn btn-warning btn-sm btn-block">
        <span>الذهاب الى صفحة سندات قبض العملاء <i class="fa fa-backward"></i></span>
    </a>
