...
@section('title', __('trans.all salaries list'))
        ...
        <div class="col-xs-12">
            <div class="card">
                ...
                <div class="card-header" style="margin: 20px 0">
                    <div class="row">
                        <div class="col-xs-6">
                            <h3 style="margin: 0; padding: 0; display: inline">{{__('trans.all salaries list')}}</h3>
{{--                            <h3 style="margin: 0; padding: 0; display: inline">{{ request('branch_id')?__('trans.all salaries list').'['.$branchName.']': __('trans.all salaries list')}}</h3>--}}
                        </div>
{{--                        <div class="col-xs-6">--}}
{{--                            @if (Auth::user()->hasPermission('create-salaries'))--}}
{{--                                <a href="{{ route('employee.salaries.create') }}" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> {{ __('trans.create') }}</a>--}}
{{--                            @endif--}}
{{--                        </div>--}}
                    </div>
                </div>
