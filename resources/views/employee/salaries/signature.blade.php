...
@push('scripts')
    ...
    <script>
        ...
        {
            var redirect_url = '{{ route('employee.salaries.salary_month_details', [$employee_id, $previous_salary_month, $current_salary_year]) }}';
            {{--let salary_details = '{{ $salary_details }}';--}}
            {{--let employee_id = '{{ $employee_id }}';--}}
            {{--let previous_salary_month = '{{ $previous_salary_month }}';--}}
            {{--let current_salary_year = '{{ $current_salary_year }}';--}}
            ...
            $.ajax({
                ...
                data: {image_data:image_data,
                    employee_salary_log_id: employee_salary_log_id,
