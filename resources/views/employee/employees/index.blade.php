...
@section('title', __('trans.all employees list'))
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            @if (Auth::user()->hasPermission('create-employees'))
                                <a href="{{ route('employee.employees.create') }}" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> {{ __('trans.create') }}</a>
                            @endif
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script src="{{ asset('js/openUrlFromSelectBox.js') }}"></script>
@endpush
