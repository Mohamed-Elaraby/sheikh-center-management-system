...
{{--    </button>--}}
    <button
        ...
        data-link="{{ route('employee.reward_receipt_print', ['reward_id' => $reward -> id]) }}"
    ...
    <a href="{{ route('employee.rewards.index') }}" class="btn btn-warning btn-sm btn-block">
        <span>الذهاب الى صفحة جميع المكافات <i class="fa fa-backward"></i></span>
    </a>
            ...
            <table style="width: 100%; table-layout: fixed">
                <tr>
                    ...
                    <td style="width: 33.33%; text-align: center">
                        <h6 class="text-center" style="font-weight: bold">سند استلام مكافاة</h6>
