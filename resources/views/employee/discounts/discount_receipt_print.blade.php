...
{{--                <p style="margin-right: 5px;">SKB AUTO MECHANICAL REPAIR L.L.C</p>--}}
            ...
            <td width="50%" style="border-bottom: 1px solid #000; font-weight: bold; font-size: xx-large">سند اخطار بالخصم</td>
            <td width="50%">
    ...
    <div class="receipt_body">
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td style="width: 70%">{{ $discount -> payment_method }}</td>
            </tr>
            <tr>
                <td>وذلك عن:</td>
...
{{--                    <img src="{{ asset('storage' . DIRECTORY_SEPARATOR . 'employees_signature' . DIRECTORY_SEPARATOR . 'discount_signature' . DIRECTORY_SEPARATOR . $discount -> id  . DIRECTORY_SEPARATOR . $employee_discount_signature -> image_name) }}" alt="" height="100" width="200">--}}
                    <p><img src="storage/employees_signature/discount_signature/{{ $discount -> id }}/{{ $employee_discount_signature -> image_name }}" alt="discount_signature" width="100"></p>
