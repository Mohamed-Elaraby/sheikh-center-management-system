$(document).ready(function () {
    ...
    $(document).on('click', '.removeField', function () {
        ...
        // discount_row_removed = $(this).closest('tr').find('.item_discount').val();
    ...
    function calc_items_total_amounts(taxable_amount_removed = 0, discount_removed = 0, tax_removed = 0, subtotal_removed = 0) {
        ...
        $('input.item_discount_amount').each(function () {
            ...
            _discount_element.val((calc_discount - discount_removed).toFixed(2)); // insert total amount inside total input
        });
        ...
        $('input.item_tax_amount').each(function () {
            ...
            calc_tax = (tax_value);
            _total_vat_element.val((calc_tax - tax_removed).toFixed(2)); // insert total amount inside total input
        ...
        $('input.item_sub_total').each(function () {
            ...
            }else
            {
                ...
                _amount_due_element.val(((calcSubTotal - subtotal_removed) - (amount_paid + amount_paid_bank) - calc_supplier_discount_amount()).toFixed(2)); // insert total amount inside total input
            }
    ...
    function calc_supplier_discount_amount() {
        ...
        supplier_discount_type = $('#supplier_discount_type').val();
