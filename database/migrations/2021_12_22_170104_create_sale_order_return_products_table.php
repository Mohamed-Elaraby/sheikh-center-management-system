...
class CreateSaleOrderReturnProductsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sale_order_return_products', function (Blueprint $table) {
            ...
            $table->bigInteger('sale_order_return_id')->unsigned();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('sale_order_return_products');
    }
}
