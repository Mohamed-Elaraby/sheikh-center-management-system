...
class CarTypeDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($query){
                return view('admin.datatableHtmlBuilderRender.carType.action', compact('query'));
            })
            ->rawColumns(['action']);
    }
    ...
    {
        return $this->builder()
                    ->setTableId('cartypedatatable-table')
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('name')            -> title( __('trans.car type') ),
